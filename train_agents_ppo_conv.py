...
from ray.rllib.models.torch.torch_modelv2 import TorchModelV2 # Volvemos al modelo simple

class AI_Economist_CNN_PyTorch(TorchModelV2, nn.Module):
    """
    Versión LIGERA: Solo CNN + MLP. 
    Ideal para entrenamiento corto (1.4M steps).
    Sin LSTM.
    """
    def __init__(self, obs_space, action_space, num_outputs, model_config, name):
        ...
        # --- Detección de Inputs (Igual que antes) ---
        ...
        # --- 3. Salida Directa (Sin LSTM) ---
        concat_dim = cnn_out_dim + 32
        
        # Capa oculta antes de la acción
    ...
    def forward(self, input_dict, state, seq_lens):
        ...
        # --- A. Procesar Inputs (Igual que antes) ---
        flat_inputs = []
        cnn_out = None
...
def build_multiagent_policies(env_obj, run_configuration):
    ...
    agent_model = {
        ...
        "use_lstm": False, 
        # Ya no importa lstm_cell_size ni max_seq_len
    }
